...
<head>
    ...
    <script src="../../static/cdn/js/uikit.js"></script>
    <script src="../../static/cdn/js/uikit-icons.js"></script>
    <script src="../../static/cdn/js/ion.rangeSlider.js"></script>
    <script src="../../static/cdn/js/jquery.sumoselect.js"></script>
    <script src="../../static/cdn/js/responsiveCarousel.min.js"></script>
</head>
