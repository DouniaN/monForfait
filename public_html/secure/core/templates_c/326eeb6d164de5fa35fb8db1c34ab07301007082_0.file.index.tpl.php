<?php
/* Smarty version 3.1.33, created on 2021-04-17 15:34:16
  from 'C:\xamp\htdocs\10-04-2021\secure\template\tpl\index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_607ae3d8638d16_35530561',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '326eeb6d164de5fa35fb8db1c34ab07301007082' => 
    array (
      0 => 'C:\\xamp\\htdocs\\10-04-2021\\secure\\template\\tpl\\index.tpl',
      1 => 1618666443,
      2 => 'file',
    ),
  ),
...
function content_607ae3d8638d16_35530561 (Smarty_Internal_Template $_smarty_tpl) {
?>
<html>
aaaaaaaaaaaaaaaaaaa
...
<head>
    ...
    <link rel="stylesheet" href="C:\xamp\htdocs\10-04-2021\secure\template\tpl\cdn\css\uikit.css" type="text/css"/>
    <link rel="stylesheet" href="C:\xamp\htdocs\10-04-2021\secure\template\tpl\cdn\css\mzs.css" type="text/css"/>
    <link rel="stylesheet" href="C:\xamp\htdocs\10-04-2021\secure\template\tpl\cdn\css\ion.rangeSlider.css" type="text/css"/>

    <link rel="stylesheet" href="C:\xamp\htdocs\10-04-2021\secure\template\tpl\cdn\css\sumoselect.css" />
...
>
    <?php echo '<script'; ?>
 src="cdn/js/uikit.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="cdn/js/uikit-icons.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="cdn/js/ion.rangeSlider.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="cdn/js/jquery.sumoselect.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="cdn/js/responsiveCarousel.min.js"><?php echo '</script'; ?>
>
</head>
...
<body>
        ...
        <div class="mzs__header mzs-shadow-d1">
            ...
            <nav class="uk-navbar uk-navbar-container mb-show">
                ...
                <div class="uk-navbar-center">
                    <a href="" class="uk-navbar-item uk-logo"><img src="cdn/images/logo.png"></a>
                </div>
                ...
                <ul class="uk-margin-remove" uk-accordion="multiple: true" uk-scrollspy="target: > li; cls:uk-animation-slide-bottom; delay: 300">
                        ...
                        <div class="uk-accordion-title pos-relative">
                            <div class="mzs__wbox  mz__table">
                                <div class="mzs__wbox-imgwrap">
                                    <img class="mzs__wbox-img" src="cdn/images/img-sfr.png">
                                </div>
                            </div>
                        ...
                        <div class="uk-accordion-content w100">
                            <div class="mzs__vbox-open">
                                <div class="mzs__vbox-o-ico mz__table">
                                    <img src="cdn/images/checked.png">
                                </div>
                    ...
                    <li class="mz-tabel">
                        ...
                        <div class="uk-accordion-title pos-relative">
                            <div class="mzs__wbox  mz__table">
                                <div class="mzs__wbox-imgwrap">
                                    <img class="mzs__wbox-img" src="cdn/images/orange.jpg">
                                </div>
                            </div>
                            <div class="mzs__wboxtitles mz__table mz__table-middle">
                    ...
                    <li class="mz-tabel">
                        ...
                        <div class="uk-accordion-title pos-relative">
                            <div class="mzs__wbox  mz__table">
                                <div class="mzs__wbox-imgwrap">
                                    <img class="mzs__wbox-img" src="cdn/images/Sosh.png">
                                </div>
                            </div>
                            <div class="mzs__wboxtitles mz__table mz__table-middle">
                        ...
                        <div class="crsl-wrap">
                            <div class="crsl-item">
                                <div class="mzs__news-conter">
                                    <div class="mz__table">
                                        <img class="mzs__news-img" src="cdn/images/new-1.png">
                                    </div>
                    ...
                    <div class="crsl-items" data-navigation="navbtns">
                        <div class="crsl-wrap">
                            <div class="crsl-item">
                                <div class="mzs__news-conter">
                                    <div class="mz__table">
                                        <img class="mzs__news-img" src="cdn/images/new-2.png">
                                    </div>
                                    <div class="mz__table va-top">
    ...
    <div class="mzs-like">
        <!-- Facebook -->
        <div class="fb-like" data-href="http://www.monforfait.fr/" data-width="200" data-layout="box_count" data-action="like" data-size="small" data-show-faces="false" data-share="false"></div>
...
>(function(d, s, id) {
            ...
            js.src = "//connect.facebook.net/fr_FR/sdk.js#xfbml=1&version=v2.9&appId=1182079331890399";
            ...
            <div uk-grid>
                <div class="uk-width-1-2">
                    <div class="mzs__footer-brand">
                        <img src="cdn/images/logo-white.png">
                    </div>
