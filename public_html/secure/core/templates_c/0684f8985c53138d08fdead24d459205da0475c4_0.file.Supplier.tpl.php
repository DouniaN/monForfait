<?php
/* Smarty version 3.1.33, created on 2021-04-17 12:33:22
  from 'C:\xamp\htdocs\10-04-2021\secure\template\tpl\Supplier.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_607ab97250e9c4_68471309',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0684f8985c53138d08fdead24d459205da0475c4' => 
    array (
      0 => 'C:\\xamp\\htdocs\\10-04-2021\\secure\\template\\tpl\\Supplier.tpl',
      1 => 1618655599,
      2 => 'file',
    ),
  ),
  'includes' => 
  array (
    'file:C:\\xamp\\htdocs\\10-04-2021\\secure\\template\\tpl\\common\\menu.tpl' => 1,
  ),
),false)) {
function content_607ab97250e9c4_68471309 (Smarty_Internal_Template $_smarty_tpl) {
?><!Doctype html>

<?php $_smarty_tpl->_subTemplateRender('file:C:\xamp\htdocs\10-04-2021\secure\template\tpl\common\menu.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
		...
		<div class="modal-content">
			<form id="EditsupplierForm">
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						<label>logo</label>
						<input type="text" id="logoEdit" class="form-control" required>
					</div>						
				</div>
				<div class="modal-footer">
					<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
				...
				if(supplier!="" && logo!=""){
					$.ajax({
						...
						success: function(dataResult)
						{
							...
							$(".closeModelAdd").click();
							$("#success").show();
							$('.messageSucces').html('Ajout efféctuée avec succéss!'); 
							load_data();														
						}
					});
				}
				...
				if(supplier!="" && logo!=""){
					...
					$.ajax({
						...
						success: function(dataResult){
							...
							load_data();
							$("#success").show();
							$('.messageSucces').html('Modification efféctuée avec succéss!'); 
